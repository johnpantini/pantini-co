...
![Ava](<../.gitbook/assets/image (352) (1).png>)
...
После установки откройте клиент (найдите значок в системном лотке, где переключается язык), нажмите на него, чтобы открыть контекстное меню, и выберите пункт с адресом, это скопирует адрес в буфер обмена:

![Пример для Mac](<../.gitbook/assets/image (346).png>)
...
Проставьте два флажка, введите адрес и нажмите **Готово**:

![](<../.gitbook/assets/image (354).png>)

`\\10.242.42.42\ppp`

Замените адрес на актуальный для вашего сервера. Появится окно ввода пароля и имени пользователя. Имя пользователя **pppuser**

Пароль вы вводили в секрете, когда создавали сервис в ppp.
...
Откройте Finder, нажмите Command + K, заполняйте аналогично Windows. Если хотите, чтобы после перезагрузки диск подключался автоматически:

Войдите в Системные настройки из меню Apple. Щёлкните «Учетные записи». Нажмите «Элементы входа». Нажмите кнопку +, чтобы добавить еще один элемент входа. Найдите сетевой диск, который вы ранее подключили, и нажмите «Добавить».
