...
![Пример для Mac](<../.gitbook/assets/image (346) (1) (1).png>)
...
![Пример для клиента Windows, пункт Open Control Panel... контекстного меню клиента](<../.gitbook/assets/image (346) (1).png>)
