...
![Ava](<../.gitbook/assets/image (352) (1) (1).png>)
...
![Пример для Mac](<../.gitbook/assets/image (346) (1).png>)
...
Откройте клиент ZeroTier на компьютере снова, присоединитесь к сети ZeroTier, введя её идентификатор, скопированный из панели управления ZeroTier в браузере (раздел **Basics**, поле **Network ID**):

![Пример для клиента Windows](<../.gitbook/assets/image (346).png>)
