...
![Форма входа в Аврору](<../.gitbook/assets/image (26).png>)
...
![Это окно отключим](<../.gitbook/assets/image (27).png>)
...
![Исполнимый файл Авроры называется Terminal.exe](<../.gitbook/assets/image (28).png>)
...
![Выбор столбцов](<../.gitbook/assets/image (32).png>)
...
![Выбор столбцов для отображения](<../.gitbook/assets/image (34).png>)
...
![Настройка цветов](<../.gitbook/assets/image (35).png>)

Посмотрим, каким цветом выделился процесс Авроры. На моей системе это выглядит следующим образом:

![Таблица процессов в Process Explorer](<../.gitbook/assets/image (36).png>)
...
![Варианты для загрузки](<../.gitbook/assets/image (37).png>)

После распаковки запускаем приложение **dnSpy.exe с правами администратора**:

![Главное окно dnSpy](<../.gitbook/assets/image (38).png>)
...
![Терминал загружен в декомпилятор](<../.gitbook/assets/image (40).png>)
...
![Декомпилированная функция Main](<../.gitbook/assets/image (41).png>)
...
![Добавления аргумента командной строки](<../.gitbook/assets/image (42).png>)
...
![Анализ использования класса PasswordCommandLineParameter](<../.gitbook/assets/image (43).png>)
...
![Если хотите самостоятельно скомпилировать шифровальщик паролей для Авроры](<../.gitbook/assets/image (58).png>)
...
![Добавляем зашифрованный пароль в аргумент --key](<../.gitbook/assets/image (44).png>)
...
![Устанавливаем breakpoint](<../.gitbook/assets/image (45).png>)
...
![Параметры запуска для отладки](<../.gitbook/assets/image (46).png>)
...
![Вторая точка останова сработал](<../.gitbook/assets/image (39) (1).png>)
...
![Фрагмент дерева для узла this](<../.gitbook/assets/image (50).png>)
...
![Правка метода](<../.gitbook/assets/image (51).png>)
...
![Меню "Файл"](<../.gitbook/assets/image (52).png>)

Нажимаем ОК:

![Сохранение правок](<../.gitbook/assets/image (53).png>)
...
![Пароль успешно подставляется в поле при запуске](<../.gitbook/assets/image (54).png>)
...
![Метод, потенциально отвечающий за код кнопки Войти](<../.gitbook/assets/image (55).png>)
...
![Выбираем метод, где программно нажмём кнопку "Войти"](<../.gitbook/assets/image (56).png>)
...
![Разблокировка исполнимого модуля](<../.gitbook/assets/image (57).png>)
