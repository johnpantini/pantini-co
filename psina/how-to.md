...
#### Ошибка "Облако под названием ppp не найдено в Yandex Cloud"

Для решения можно попробовать перейти в раздел **Права доступа** в [панели управления облаком](https://console.cloud.yandex.ru/cloud).

В верхней части страницы нажмите кнопку **Назначить роли**, затем добавьте группу **All authenticated users**:

![](<../.gitbook/assets/image (346).png>)

Затем добавьте роль `viewer`:
